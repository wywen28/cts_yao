...
public class CATManualUnitSeparateGUI
{
	...
	public CATManualUnitSeparateGUI(AnalysisFile file) {
		this.file = file;
		orig_units = file.getAllTestUnit();
	...
	{
		private CATManualUnitSeparateGUI demo;

		public UnitListSelection(CATManualUnitSeparateGUI testModuleSeparate) {
	...
	{
		private CATManualUnitSeparateGUI demo;
		public ShellCloseListener(CATManualUnitSeparateGUI de ) 
		{
			demo = de;
		} 
	...
	private class ensureSelection implements SelectionListener
	{
		...
		public ensureSelection(CATManualUnitSeparateGUI demo) {
			this.demo = demo;
